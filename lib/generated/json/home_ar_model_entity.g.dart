...
HomeArModelEntity $HomeArModelEntityFromJson(Map<String, dynamic> json) {
  final HomeArModelEntity homeArModelEntity = HomeArModelEntity();
  final int? curPage = jsonConvert.convert<int>(json['curPage']);
  if (curPage != null) {
    homeArModelEntity.curPage = curPage;
  }
  final List<HomeArModelDatas>? datas = (json['datas'] as List<dynamic>?)
      ?.map(
          (e) => jsonConvert.convert<HomeArModelDatas>(e) as HomeArModelDatas)
      .toList();
  if (datas != null) {
    homeArModelEntity.datas = datas;
  }
  final int? offset = jsonConvert.convert<int>(json['offset']);
  if (offset != null) {
    homeArModelEntity.offset = offset;
  }
  final bool? over = jsonConvert.convert<bool>(json['over']);
  if (over != null) {
    homeArModelEntity.over = over;
  }
  final int? pageCount = jsonConvert.convert<int>(json['pageCount']);
  if (pageCount != null) {
    homeArModelEntity.pageCount = pageCount;
  }
  final int? size = jsonConvert.convert<int>(json['size']);
  if (size != null) {
    homeArModelEntity.size = size;
  }
  final int? total = jsonConvert.convert<int>(json['total']);
  if (total != null) {
    homeArModelEntity.total = total;
  }
  return homeArModelEntity;
}

Map<String, dynamic> $HomeArModelEntityToJson(HomeArModelEntity entity) {
...
extension HomeArModelEntityExtension on HomeArModelEntity {
  HomeArModelEntity copyWith({
    int? curPage,
...
extension HomeArModelDatasExtension on HomeArModelDatas {
  HomeArModelDatas copyWith({
    bool? adminAdd,
    String? apkLink,
    int? audit,
    String? author,
